...
//exports.crawleGraph =  
    ...
    try {
        ...
        for(let movie of queryRes.row) {
            ...
            // console.log(encodeURI("https://movie.naver.com/movie/search/result.naver?section=movie&query="+ movie.title));
            // window에서 url 한글 깨지는 오류 고쳐야함
            await driver.get(encodeURI("https://movie.naver.com/movie/search/result.naver?section=movie&query="+ movie.title));
